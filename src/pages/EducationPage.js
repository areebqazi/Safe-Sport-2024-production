        ...
        <InView>
            <div className="education-page">
                <div className='page-title-div'>
                    <h1 className='page-title'>{language === 'english' ? 'Safe Sport Education' : 'Éducation sur la Maltraitance'}</h1>
                ...
                <div className='lang-button-div'>
                <button className='mobile-btn-lang' onClick={toggleLanguage}>
                    {language === 'english' ? 'Passer au Français' : 'Switch to Englis'}
                </button>
            </div> */}
                <Authenticator signUpAttributes={['given_name', 'family_name', 'birthdate']} className='education-page-authenticator'>
                                ...
                                {showCongratulationsPopup && (
                                    <div className="congratulations-popup congrats-div">
                                        ...
                                        <div ref={divRef} className='certificate-wrapper'>
                                            ...
                                            <img src={language === 'english' ? EngCertificate : FreCertificate} alt="Certification" className="certificate" />
                                        </div>
                                        <br></br>


                                        <button className='dwn-btn ' onClick={handleDownloadImage} disabled={!sport}>{language === 'english' ? 'Download Certificate' : 'Télécharger le certificat'}</button>
                                    </div>
                                )}
                            </div>
                        </div>
